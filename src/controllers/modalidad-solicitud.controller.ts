...
export class ModalidadSolicitudController {
  ...
  async find(
    ...
    return this.modalidadRepository.tienemuchosSolicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.modalidadRepository.tienemuchosSolicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.modalidadRepository.tienemuchosSolicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.modalidadRepository.tienemuchosSolicitud(id).delete(where);
  }
}
