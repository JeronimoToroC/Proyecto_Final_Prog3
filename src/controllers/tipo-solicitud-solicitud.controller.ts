...
export class TipoSolicitudSolicitudController {
  ...
  async find(
    ...
    return this.tipoSolicitudRepository.tienemuchosSolicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.tipoSolicitudRepository.tienemuchosSolicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.tipoSolicitudRepository.tienemuchosSolicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.tipoSolicitudRepository.tienemuchosSolicitud(id).delete(where);
  }
}
