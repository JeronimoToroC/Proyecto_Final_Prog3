...
export class DepartamentoProponenteController {
  ...
  async find(
    ...
    return this.departamentoRepository.muchosDepartamentoProponente(id).find(filter);
  }
  ...
  async create(
    ...
    return this.departamentoRepository.muchosDepartamentoProponente(id).create(proponente);
  }
  ...
  async patch(
    ...
    return this.departamentoRepository.muchosDepartamentoProponente(id).patch(proponente, where);
  }
  ...
  async delete(
    ...
    return this.departamentoRepository.muchosDepartamentoProponente(id).delete(where);
  }
}
